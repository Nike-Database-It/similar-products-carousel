...
var char, shoeID, priceFull, priceSale, prodCat, prodCols, prodLine, revsAvg, revsCnt, img, output;
...
// file.write('product_sku, price_full, price_sale, product_cat, product_colors, product_line, reviews_avg, reviews_cnt, image_source\n');
...
for (let i = 0; i < records; i += 1) {
  ...
  output = `${shoeID}, ${priceFull}, ${priceSale}, ${prodCat}, ${prodCols}, ${prodLine}, ${revsAvg}, ${revsCnt}, ${img}\n`;
  file.write(output);
  if (i % 20000 === 0) {
    console.clear();
